...
public class PasswordManagerController extends AbstractController {
	...
	public ResponseEntity<String> forgotPassword(@EmailValidator @PathVariable String email) {
	...
	/**
	 * Method used to reset user password. This takes the new password and the token generated by
	 * forgotPassword()
	 * 
	 * @param passwordResetDTO - Object to transfer password and confirm password
	...
	public ResponseEntity<String> changePasswordBasedOnToken(@Valid @RequestBody PasswordResetDTO passwordResetDTO,
